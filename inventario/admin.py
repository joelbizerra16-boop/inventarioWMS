...
@admin.register(CicloLoteExecucao)
class CicloLoteExecucaoAdmin(admin.ModelAdmin):
    list_display = ('pk', 'ciclo', 'status', 'data_geracao', 'usuario_geracao')
    list_filter = ('status',)
    ordering = ('-data_geracao',)


@admin.register(CicloLoteExecucaoItem)
class CicloLoteExecucaoItemAdmin(admin.ModelAdmin):
    list_display = ('lote', 'ciclo_sku', 'sequencia', 'status')
    list_filter = ('status',)
